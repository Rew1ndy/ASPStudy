...
public class WeatherService
{
    ...
    private readonly string _apiKey = "009bb6c2b805a334059dcaa734620703"; // заміни на свій API ключ
    ...
    public async Task<string> GetWeatherAsync(string region)
    {
        ...
        return response != null ?
               $"Температура: {response.Main.Temp}°C, Опис: {response.Weather[0].Description}" :
               "Інформація про погоду недоступна";
    }
}
